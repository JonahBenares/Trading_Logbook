			    ...
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
						...
						<?php
							...
							break;
							case($max_logged>=$current_time):
							if($rowCount==$duration_time){
								echo "<div class='modal-body' style='height:200px'>
									<div class='contianer'>	
										<div class='alert alert-danger'>
											<h5><i class='material-icons'>warning</i><strong> Error</strong></h5>
						   	...
						   	$l=$duration_time; //endo
                    	 	break;	
                    	 	case($max_logged<=$st && $max_logged<=$current_time):
						?>	
						<div class="modal-body">
							<form method = "POST" name = "add-activity" id = "add-activity">
								<div class="col-md-6">
								...
								echo "<div class='modal-body' style='height:200px'>
									<div class='contianer'>	
										<div class='alert alert-danger'>
											...
											<div class='form-group label-floating'> 					
												<div id='errorBox'>";						   
											   	echo "Sorry, you are unable to add activity, Please wait next hour!";
											   	echo "</div></div></div></div></div>";
				   			}else {
					     		echo "<div class='modal-body' style='height:200px'>
									<div class='contianer'>	
							...
							echo "<div class='modal-body' style='height:200px'>
						        <div class='contianer'>	
								    <div class='alert alert-danger'>
										...
										<div class='form-group label-floating'> 					
											<div id='errorBox'>";
									   	echo "Your not Yet on Duty, Please contact System Administrator";
									   	echo "</div></div></div></div></div>";
							} //switch bracket 
							break;
							default:
