...
$(add_button).click(function(e){ 
    ...
    if(x < max_fields){ //max input box 
        x++; 
        $(wrapper).append('<div class="row"><input class="btn btn-sm btn-primary col-xs-6" style="width:80%" type="file" id="file'+x+'" name="myfile[]"> <a class="col-xs-6" id="add_field_button" style="width:10%"><i class="material-icons">clear</i></a> </div>'); //add input box
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="col-md-12" id="input_fields_wrap" >		
                                            <div class="row">
                                                ...
                                                <a class="col-xs-6" id="add_field_button" style="width:10%"><i class="material-icons">add</i></a>
                                            </div>
                                        </div>
                                        <center>
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Activity</label>
                                                <hr>
                                                <p style="text-indent: 50px;font-weight: 400;"><?php echo $row['notes'];?></p>
                                                <!-- <input type="text" name = "notes" class="form-control" style="width:100%" value = "" readonly> -->
                                                <hr>
                                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <?php } else { ?>   
                                                <div class="column" >  
                                                    <a href='images/<?php echo $rows['file_name']; ?>' target='_blank'><img class=" hover-shadow cursor  thumbnail sd" src='uploads/files.png' width="230" height="230">
